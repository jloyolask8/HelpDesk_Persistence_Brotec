...
@NamedQueries({
    ...
    @NamedQuery(name = "ModeloProducto.findAllByQuery", query = "SELECT o FROM ModeloProducto o WHERE (LOWER(o.nombre) LIKE CONCAT(LOWER(:q), '%')) or  (LOWER(o.producto.nombre) LIKE CONCAT(LOWER(:q), '%'))"),
