...
public enum EnumSubEstadoCaso {
    ...
    //
    PREENTREGA_NUEVO(new SubEstadoCaso(EnumTipoCaso.PREENTREGA.getTipoCaso(), "PREENTREGA_NUEVO", "Nuevo", EnumEstadoCaso.ABIERTO.getEstado(), "Estado inicial de un caso de preentrega cuando ha sido creado.", false, "FFFFFF", "00aeed", true)),
    PREENTREGA_EN_PROCESO(new SubEstadoCaso(EnumTipoCaso.PREENTREGA.getTipoCaso(), "PREENTREGA_EN_PROCESO", "En Proceso", EnumEstadoCaso.ABIERTO.getEstado(), "Se están realizando los trabajos necesarios para solucionar el caso de pre-entrega.", false, "FFFFFF", "EB6420", false)),
    PREENTREGA_SOLUCIONADO(new SubEstadoCaso(EnumTipoCaso.PREENTREGA.getTipoCaso(), "PREENTREGA_SOLUCIONADO", "Solucionado", EnumEstadoCaso.CERRADO.getEstado(), "Caso solucionado. Listo para entrega", false, "FFFFFF", "563D7C", false)),
