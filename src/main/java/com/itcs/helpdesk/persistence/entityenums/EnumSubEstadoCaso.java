...
public enum EnumSubEstadoCaso {
    ...
    //
    ENTREGA_NUEVO(new SubEstadoCaso(EnumTipoCaso.ENTREGA.getTipoCaso(), "PREENTREGA_NUEVO", "Nuevo", EnumEstadoCaso.ABIERTO.getEstado(), "Estado inicial de un caso de entrega cuando ha sido creado.", false, "FFFFFF", "00aeed", true)),
    ENTREGA_EN_PROCESO(new SubEstadoCaso(EnumTipoCaso.ENTREGA.getTipoCaso(), "PREENTREGA_EN_PROCESO", "En Proceso", EnumEstadoCaso.ABIERTO.getEstado(), "Se están realizando los trabajos necesarios para solucionar el caso de entrega.", false, "FFFFFF", "EB6420", false)),
    ENTREGA_SOLUCIONADO(new SubEstadoCaso(EnumTipoCaso.ENTREGA.getTipoCaso(), "PREENTREGA_SOLUCIONADO", "Solucionado", EnumEstadoCaso.CERRADO.getEstado(), "Caso solucionado. Listo para entrega", false, "FFFFFF", "563D7C", false)),
